...
//        loadPartialView('/Home/SortedProperties', this);
//    });
//});
//document.addEventListener("DOMContentLoaded", function () {
//    // Function to load a partial view dynamically and handle the active class
...
//    // Add event listeners to both buttons
//    document.getElementById("sortedProperties").addEventListener("click", function () {
//        loadPartialView('Home/SortedProperties', this);
//    });
//});
...
//    var status = document.getElementById('Status').value || 0;
//    var priceRange = document.getElementById('PriceRange').value;
//    var areaSize = document.getElementById('AreaSize').value;
//    var bedrooms = document.getElementById('Bedrooms').value || 0;
//    var bathrooms = document.getElementById('Bathrooms').value || 0;
...
//    let itemsPerPage = 3;  // Default number of items per page
//    let currentPage = 0;
//    const items = Array.from(content.getElementsByClassName('property-item'));
//    const paginationContainer = document.getElementById('paginationContainer');
//    const itemsPerPageDropdown = document.getElementById('items_per_page');
...
//        nextButton.classList.toggle('disabled', page === Math.ceil(items.length / itemsPerPage) - 1);
//    }

//    // Event listener for changing items per page
//    itemsPerPageDropdown.addEventListener('change', function () {
//        itemsPerPage = parseInt(this.value, 10);  // Update itemsPerPage based on the dropdown value
//        currentPage = 0;  // Reset to the first page
//        createPagination();  // Recreate pagination based on the new items per page
//    });
